...
class SearchResult(BaseModel):
    ...
    book_author: Optional[str] = Field(description="Author of the book", default=None)
    chapter_index: int = Field(description="Chapter index in the book")
    chapter_title: Optional[str] = Field(description="Title of the chapter", default=None)
